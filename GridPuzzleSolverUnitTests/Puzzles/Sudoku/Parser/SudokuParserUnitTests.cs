...
namespace GridPuzzleSolverUnitTests.Puzzles.Sudoku.Parser
{
    ...
    public class SudokuParserUnitTests
    {
        ...
        public void SudokuParser_ParsePuzzle_Successful()
        {
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[0]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[3]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[4]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[5]).CellValue, Is.EqualTo(5u));
            Assert.That(((PuzzleCell)puzzle.Cells[6]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[7]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[12]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[13]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[14]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[15]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[16]).CellValue, Is.EqualTo(4u));
            Assert.That(((PuzzleCell)puzzle.Cells[17]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[20]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[21]).CellValue, Is.EqualTo(4u));
            Assert.That(((PuzzleCell)puzzle.Cells[22]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[23]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[24]).CellValue, Is.EqualTo(1u));
            Assert.That(((PuzzleCell)puzzle.Cells[25]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[28]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[31]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[32]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[35]).CellValue, Is.Zero);

            Assert.That(((PuzzleCell)puzzle.Cells[36]).CellValue, Is.EqualTo(9u));
            Assert.That(((PuzzleCell)puzzle.Cells[37]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[38]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[39]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[44]).CellValue, Is.Zero);

            Assert.That(((PuzzleCell)puzzle.Cells[45]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[46]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[51]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[52]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[53]).CellValue, Is.Zero);

            Assert.That(((PuzzleCell)puzzle.Cells[54]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[55]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[56]).CellValue, Is.EqualTo(5u));
            Assert.That(((PuzzleCell)puzzle.Cells[57]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[61]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[62]).CellValue, Is.Zero);

            Assert.That(((PuzzleCell)puzzle.Cells[63]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[64]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[68]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[69]).CellValue, Is.EqualTo(6u));
            Assert.That(((PuzzleCell)puzzle.Cells[70]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[71]).CellValue, Is.Zero);

            Assert.That(((PuzzleCell)puzzle.Cells[72]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[73]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[74]).CellValue, Is.Zero);
            ...
            Assert.That(((PuzzleCell)puzzle.Cells[77]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[78]).CellValue, Is.Zero);
            Assert.That(((PuzzleCell)puzzle.Cells[79]).CellValue, Is.EqualTo(8u));
            Assert.That(((PuzzleCell)puzzle.Cells[80]).CellValue, Is.Zero);
        }
    }
}
